...
//$bb=$r['B_CODE'];
  //$var=$r['number'];
echo'	
<tr><td>'.$r['model'].'</td><td>'.$r['number'].'</td><td>'.$r['capacity'].'</td><td>'.$r['rent'].'</td><td><button class="btn btn-primary" onclick=window.location.href="rent.php?username='.$username.'&number='.$r['number'].'">Rent car</button></td></tr>'
