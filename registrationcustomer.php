        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              ...
              <form method="post" action="registrationcustomer.php">

                <div class="form-outline mb-4">
                  <input type="text" id="form3Example1cg" class="form-control form-control-lg" required="" name="aid" />
                  <label class="form-label" for="form3Example1cg">Customer username</label>
                </div>
...
$insert = "INSERT INTO customer VALUES('$username','$address','$phone','$password')";
