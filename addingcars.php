        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              <h2 class="text-uppercase text-center mb-5">Add car details</h2>

              <form method="post" action="addingcars.php">
                ...
                <div class="form-outline mb-4">
                  <input type="text" id="form3Example4cdg" class="form-control form-control-lg" required="" name="password" />
                ...
                <div class="d-flex justify-content-center">
                  <input type="submit"
                    class="btn btn-success btn-block btn-lg gradient-custom-4 text-body" name="submit" value="Add car">
                </div>
...
include("connect.php");
    ...
    $st="available";
$insert = "INSERT INTO cars(`model`,`number`,`capacity`,`rent`,`agency`,`status`) VALUES('$username1','$address','$phone','$password','$username','$st')";
...
if($rslt){
    echo '
        ...
        window.location = "agencydashboard.php?username='.$username.'";
        </script>   
    ' ; 
}
